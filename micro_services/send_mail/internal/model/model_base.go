...
func init() {
	...
	tables["api_user"] = api_userTableInfo
	tables["book"] = bookTableInfo
	tables["pay_order"] = pay_orderTableInfo
	tables["pay_order_detail"] = pay_order_detailTableInfo
	tables["shop_history"] = shop_historyTableInfo
}
